...
function location_filter()
{
    ...
    <form class="location_filter" data-autoload="<?php echo (isset($_REQUEST['zip']))?TRUE:FALSE;?>">
        ...
        <select name="radius" class="radius">
            ...
            <option value="<?php echo $radiu;?>" <?php
 if ($radiu == $_REQUEST['radius'])echo' selected';?>>
                <?php echo $radiu;?> miles
            </option>
            <?php endforeach;?>
        </select>
        <select name="views">
            ...
            <option value="<?php echo $view;?>" <?php
 if ($view == $_REQUEST['views'])echo' selected';?>>
                <?php echo $view;?>
            </option>
            <?php endforeach;?>
        </select>
...
function location_map()
{
    ...
    <script src="<?php echo get_template_directory_uri(); ;?>/js/gmap3.min.js">
    </script>
    <div class="map location_map" style="height: 300px;">
    </div>
    <?php
}
function location_list()
{
    ...
    <div class="result">
        ...
        <ul class="location_result">
            <?php location_load_default();?>
        </ul>
    </div>
    <?php
}
